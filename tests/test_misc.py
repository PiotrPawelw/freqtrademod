...
def test_file_load_json(mocker, testdatadir) -> None:
    ...
    assert ret
    # 8 .json is empty and will fail if it's loaded. .json.gz is a copy of
    # 1.json
...
def test_is_file_in_dir(tmp_path):
    ...
    # Test that the function returns False when the file is not in the
    # directory
