...
class StrategyTestV3(IStrategy):
    ...
    # TODO: Can this work with protection tests? (replace HyperoptableStrategy
    # implicitly ... )
    @property
    def protections(self):
        prot = []
        if self.protection_enabled.value:
            # Workaround to simplify tests. This will not work in real
            # scenarios.
    ...
    def leverage(
        ...
        **kwargs,
        ...
        # Bot-logic must make sure it's an allowed leverage and eventually
        # adjust accordingly.
