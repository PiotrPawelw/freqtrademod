...
def test_get_trade_stake_amount_unlimited_amount(
    ...
    # create one trade, order amount should be 'balance / (max_open_trades -
    # num_open_trades)'
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Above max_stake, below stake available
        (700, 11, 1000, 400, None, 400),
        (20, 15, 10, 10000, None, 0),  # Minimum stake > stake_available
        (9, 11, 100, 10000, None, 11),  # Below min stake
        # Below min stake and min_stake > stake_available
        (1, 15, 10, 10000, None, 0),
        # Below min stake and stake * 1.3 > min_stake
        (20, 50, 100, 10000, None, 0),
        # No min-stake-amount could be determined
