...
def test_validate_order_time_in_force(default_conf, mocker, caplog):
    caplog.set_level(logging.INFO)
    # explicitly test bybit, exchanges implementing other policies need
    # separate tests
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Price above spread ... average is lower
        ("buy", 25.590, 100, 25.5672),
        ...
        # price below spread - average is higher
        ("sell", 25.510, 100, 25.5625),
...
def test_get_historic_ohlcv(default_conf, mocker, caplog, exchange_name, candle_type):
    ...
    async def mock_candle_hist(pair, timeframe, candle_type, since_ms):
        ...
        ohlcv = [
            [
                # unix timestamp ms
                dt_ts(now + timedelta(minutes=5 * (calls + i))),
                1,  # open
                2,  # high
                3,  # low
                4,  # close
...
async def test__async_kucoin_get_candle_history(default_conf, mocker, caplog):
    ...
    with patch("freqtrade.exchange.common.asyncio.sleep", get_mock_coro(None)):
        ...
        # Expect the "returned exception" message 12 times (4 retries * 3
        # (loop))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Value from order_book_l2 fixture - bids side
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Don't fail for unavailable pairs.
