...
class Hyperopt:
    ...
    def run_optimizer_parallel(self, parallel: Parallel, asked: list[list]) -> list[dict[str, Any]]:
        ...
        def optimizer_wrapper(*args, **kwargs):
            # global log queue. This must happen in the file that initializes
            # Parallel
            logging_mp_setup(
            ...
            with Parallel(n_jobs=config_jobs) as parallel:
                ...
                with get_progress_tracker(cust_callables=[self._hyper_out]) as pbar:
                    ...
                    if self.analyze_per_epoch:
                        ...
                        # This allows dataprovider to load it's informative
                        # cache.
                    ...
                    for i in range(evals):
                        ...
                        # iteration (should not exceed self.total_epochs in
                        # total)
