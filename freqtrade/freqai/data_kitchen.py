...
class FreqaiDataKitchen:
    ...
    def filter_features(
        ...
        if training_filter:
            ...
            # if labels has multiple columns (user wants to train multiple
            # modelEs), we detect here
            ...
            # that was based on a single NaN is ultimately protected from buys
            # with do_predict
    ...
    def check_if_new_training_required(
        ...
        if trained_timestamp != 0:
            ...
            if retrain:
                ...
                # unless they have data further back in time before the start
                # of the train period
    ...
    def use_strategy_to_populate_indicators(  # noqa: C901
        ...
        # check if the user is using the deprecated populate_any_indicators
        # function
