...
class FreqaiDataDrawer:
    ...
    def __init__(self, full_path: Path, config: Config):
        ...
        # dictionary holding all actively inferenced models in memory given a
        # model filename
    ...
    def set_initial_return_values(
        ...
        # ensure both dataframes have the same date format so they can be
        # merged
        ...
        with warnings.catch_warnings():
            ...
            # reindex new_pred columns to match the historic predictions
            # dataframe
    ...
    def load_data(self, coin: str, dk: FreqaiDataKitchen) -> Any:  # noqa: C901
        ...
        # try to access model in memory instead of loading object from disk to
        # save time
    ...
    def get_timerange_from_live_historic_predictions(self) -> TimeRange:
        ...
        # add 1 day to string timerange to ensure BT module will load all
        # dataframe data
