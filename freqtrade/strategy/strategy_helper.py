...
def merge_informative_pair(
    ...
    if minutes == minutes_inf:
        ...
        # https://github.com/freqtrade/freqtrade/issues/4073
    ...
    # all indicators on the informative sample MUST be calculated before this
    # point
    if ffill:
...
def stoploss_from_open(
    ...
    # formula is undefined for current_profit -1 (longs) or 1 (shorts), return
    # maximum value
