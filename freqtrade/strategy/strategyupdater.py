...
# Here we go through each respective node, slice, elt, key ... to replace
# outdated entries.
class NameUpdater(ast_comments.NodeTransformer):
    def generic_visit(self, node):
        # space is not yet transferred from buy/sell to entry/exit and thereby
        # has to be skipped.
    ...
    def visit_ClassDef(self, node):
        ...
        if any(
            ...
            # if the INTERFACE_VERSION variable does not exist, add it as the
            # first child
