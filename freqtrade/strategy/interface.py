...
class IStrategy(ABC, HyperStrategyMixin):
    ...
    # Disable checking the dataframe (converts the error into a warning
    # message)
    ...
    # A self set parameter that represents the market direction. filled from
    # configuration
    ...
    def get_latest_candle(
        ...
        try:
            ...
            return None, None
        # Explicitly convert to datetime object to ensure the below comparison
        # does not fail
    ...
    def should_exit(
        ...
        *,
        ...
        # if enter signal and ignore_roi is set, we don't need to evaluate
        # min_roi.
    ...
    def ft_stoploss_adjust(
        ...
        # Initiate stoploss with open_rate. Does nothing if stoploss is already
        # set.
        ...
        if self.trailing_stop and dir_correct:
            ...
            # Make sure current_profit is calculated using high for
            # backtesting.
    ...
    def ft_stoploss_reached(
        ...
        if (sl_higher_long or sl_lower_short) and (
            ...
            # If initial stoploss is not the same as current one then it is
            # trailing.
    ...
    def advise_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # call populate_indicators_Nm() which were tagged with @informative
        # decorator.
