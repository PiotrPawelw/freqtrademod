...
class DataProvider:
    ...
    # For multiple producers we will want to merge the pairlists instead of
    # overwriting
    ...
    def get_producer_df(
        ...
        if producer_name not in self.__producer_pairs_df:
            # We don't have this data yet, return empty DataFrame and datetime
            # (01-01-1970)
    ...
    def get_required_startup(self, timeframe: str) -> int:
        ...
        if not freqai_config.get("enabled", False):
            ...
            # make sure the startupcandles is at least the set maximum
            # indicator periods
    ...
    def get_pair_dataframe(
        ...
        if self.runmode in (RunMode.DRY_RUN, RunMode.LIVE):
            ...
            # This is necessary to prevent lookahead bias in callbacks through
            # informative pairs.
