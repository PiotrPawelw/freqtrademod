...
def calculate_sortino(
    ...
    if down_stdev != 0 and not np.isnan(down_stdev):
        ...
        # Define high (negative) sortino ratio to be clear that this is NOT
        # optimal.
        sortino_ratio = -100
...
def calculate_sharpe(
    ...
    if up_stdev != 0:
        ...
        # Define high (negative) sharpe ratio to be clear that this is NOT
        # optimal.
        sharp_ratio = -100
...
def calculate_calmar(
    ...
    if max_drawdown != 0:
        ...
        # Define high (negative) calmar ratio to be clear that this is NOT
        # optimal.
        calmar_ratio = -100
