...
class IResolver:
    ...
    # Optional config setting containing a path (strategy_path,
    # freqaimodel_path)
    ...
    def _get_valid_object(
        ...
        # Pass object_name as first argument to have logging print a reasonable
        # name.
        with PathModifier(module_path.parent):
            ...
            # The __module__ check ensures we only use strategies that are
