# pragma pylint: disable=unused-argument, unused-variable,
...
class Telegram(RPCHandler):
    ...
    def compose_message(self, msg: RPCSendMsg) -> str | None:
        if msg["type"] == RPCMessageType.ENTRY or msg["type"] == RPCMessageType.ENTRY_FILL:
            ...
            # Errors will contain exceptions, which are wrapped in triple
            # ticks.
        ...
        for r in results:
            ...
            if r["is_open"]:
                ...
                if (
                    ...
                    # Adding initial stoploss only if it is different from
                    # stoploss
                    lines.append(
                ...
                # Adding stoploss and stoploss percentage only if it is not
                # None
                lines.append(
