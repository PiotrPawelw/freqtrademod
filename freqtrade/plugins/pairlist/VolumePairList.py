    ...
    def filter_pairlist(self, pairlist: list[str], tickers: dict) -> list[str]:
        ...
        if self._use_range:
            ...
            for i, p in enumerate(filtered_tickers):
                ...
                # in case of candle data calculate typical price and
                # quoteVolume for candle
                if pair_candles is not None and not pair_candles.empty:
                    ...
                    # if pair_candles contains more candles than
                    # lookback_period
                    quoteVolume = (
                        pair_candles["quoteVolume"]
                    ...
                    # replace quoteVolume with range quoteVolume sum calculated
                    # above
