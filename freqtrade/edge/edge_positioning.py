...
class Edge:
    ...
    def _detect_next_stop_or_sell_point(
        ...
        while True:
            ...
            # If we don't find it then we assume stop_index will be far in
            # future (infinite number)
            if stop_index == -1:
            ...
            # If we don't find it then we assume sell_index will be far in
            # future (infinite number)
            if sell_index == -1:
